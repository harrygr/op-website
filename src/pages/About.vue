<template>
  <div class="ph4 mt5 pt4 mw9">
    ...
    <section class="fw2 lh-copy">
        ...
        <p>He also has collaborated with English jewelry designer Theo Fennell, and created a capsule collection made up of necklaces, bracelets, and earrings with a Native Indian theme.</p>
        <p>One other main passion that has really developed over the last two years, since he completed a gruelling 6 week muscle plan that was figured in Mens Health, is fitness/health and nutrition. Ever since he has continued to keep in shape, releasing his own fitness book called ‘6 Week Muscle Plan’.</p>
        <p>If you wish to keep unto date with all Ollie’s past, present and future projects this is the place to be. Everything from fashion, music, art, style and fitness will be posted on this site.</p>
        <p>Hope you enjoy!!</p>
    </section>
  </div>
</template>
