...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ArrayOps; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_flickity__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flickity_imagesloaded__ = __webpack_require__(51);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        initCarousel: function () {
            var options = __assign({ contain: true, initialIndex: 0, accessibility: true, imagesLoaded: true, prevNextButtons: false, pageDots: false, wrapAround: true, cellSelector: '.carousel-cell' }, this.options);
            new __WEBPACK_IMPORTED_MODULE_0_flickity___default.a(this.$refs.carousel, options);
        }
    }
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getInstagramPhotos; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_space_lift__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fetch_jsonp__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lscache__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_blueimp_md5__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_blueimp_md5___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_blueimp_md5__);




var qs = __webpack_require__(65);
var getInstagramPhotos = function (userId, accessToken) {
    var params = qs.stringify({
        access_token: accessToken,
        count: 10,
    });
    var url = "https://api.instagram.com/v1/users/" + userId + "/media/recent/?" + params;
    var key = "grams_" + userId + "_" + __WEBPACK_IMPORTED_MODULE_3_blueimp_md5___default()(params);
    var result = __WEBPACK_IMPORTED_MODULE_2_lscache__["get"](key);
    if (__WEBPACK_IMPORTED_MODULE_2_lscache__["get"](key)) {
        return Promise.resolve(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_space_lift__["a" /* Ok */])(result));
    }
    return __WEBPACK_IMPORTED_MODULE_1_fetch_jsonp__(url)
        .then(function (response) { return response.json(); })
        .then(function (response) {
        if (response.meta.code === 400) {
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_space_lift__["b" /* Err */])({
                message: response.meta.error_message,
                info: "URL: " + url,
            });
        }
        __WEBPACK_IMPORTED_MODULE_2_lscache__["set"](key, response.data, 22);
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_space_lift__["a" /* Ok */])(response.data);
    })
        .catch(function (err) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_space_lift__["b" /* Err */])(err); });
};
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        submitForm: function () {
            var _this = this;
            this.loading = true;
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(this.formAction, this.form)
                .then(function () {
                _this.loading = false;
                _this.confirmSubmission();
                _this.form = emptyForm();
            })
                .catch(function () {
                _this.loading = false;
            });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_instagram__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__carousel__ = __webpack_require__(7);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    components: {
        'op-carousel': __WEBPACK_IMPORTED_MODULE_1__carousel__["a" /* default */],
    },
    template: template,
    mounted: function () {
        var _this = this;
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__services_instagram__["a" /* getInstagramPhotos */])(this.user, this.token)
            .then(function (response) {
            response.fold(function (err) { return console.warn; }, function (media) {
                _this.images = media;
            });
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lift__ = __webpack_require__(3);
...
function fromArrayLike(arrayLike) {
    return new __WEBPACK_IMPORTED_MODULE_0__lift__["c" /* ArrayOps */]([].slice.call(arrayLike));
}
...
function range(start, stop, step) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0__lift__["c" /* ArrayOps */](result);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__object_is__ = __webpack_require__(17);
    ...
    return function () {
        ...
        if (args.length === 0) {
            ...
            for (var i = 0; i < args.length; i++) {
                var arg = args[i];
                var argKey = void 0;
                if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__object_is__["object"])(arg)) {
                    argKey = arg[memoKey];
                    if (!argKey) {
                        // Non enumerable
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_immupdate__ = __webpack_require__(62);
/* unused harmony reexport update */
/* unused harmony reexport deepUpdate */
/* unused harmony reexport DELETE */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__option__ = __webpack_require__(73);
/* unused harmony reexport Option */
/* unused harmony reexport None */
/* unused harmony reexport Some */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__result__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__array_range__ = __webpack_require__(69);
/* unused harmony reexport range */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__array_fromArrayLike__ = __webpack_require__(68);
/* unused harmony reexport fromArrayLike */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__object_set__ = __webpack_require__(72);
/* unused harmony reexport Set */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__function_memoize__ = __webpack_require__(70);
/* unused harmony reexport memoize */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__object_is__ = __webpack_require__(17);

/* unused harmony default export */ var _unused_webpack_default_export = (__WEBPACK_IMPORTED_MODULE_0__lift__["a" /* default */]);
...
function makeNone() {
    ...
    self.toArray = function () { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lift__["a" /* default */])([]); };
...
_Some.prototype = {
    ...
    toArray: function () {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lift__["a" /* default */])([this.value]);
    },
    toString: function () {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = Err;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lift__ = __webpack_require__(3);
...
_Ok.prototype = {
    ...
    map: function (fn) {
        return Ok(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__lift__["d" /* getValue */])(fn(this._value)));
    },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tachyons_css_tachyons_css__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tachyons_css_tachyons_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_tachyons_css_tachyons_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flickity_css_flickity_css__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_css__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icons_css__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_carousel__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_insta_carousel__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_insta_row__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_contact_form__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_collapsable_nav__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_image_wall__ = __webpack_require__(85);
...
__WEBPACK_IMPORTED_MODULE_4_vue___default.a.component('op-image-wall', __WEBPACK_IMPORTED_MODULE_10__components_image_wall__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_masonry_layout__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_imagesloaded__ = __webpack_require__(61);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    template: template,
    methods: {
        containerClass: function (index) {
            return index === 0 ? 'w-100' : 'w-third-ns w-50-m';
        }
    },
    mounted: function () {
        var _this = this;
        var elem = '.masonry-container';
        __WEBPACK_IMPORTED_MODULE_1_imagesloaded__(elem, function () {
            new __WEBPACK_IMPORTED_MODULE_0_masonry_layout__(elem, {
                percentPosition: true,
                columnWidth: _this.$refs.sizer,
